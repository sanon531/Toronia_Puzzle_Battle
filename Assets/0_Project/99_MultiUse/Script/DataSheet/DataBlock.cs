...
namespace ToronPuzzle.Data
{
    ...
    {
        One_D,
        Two_HL, Two_VL, Two_DiaR, Two_DiaL,
        ...
        public static Dictionary<BlockShape, int[,]> shapeDic = new Dictionary<BlockShape, int[,]>()
    {
        ...
        // 고개를 시계방향으로 90도 돌려서 계산 부탁
        // 1= 일반 블록, 2 = 공란(액체 블록 생각중 ㅠ) 
        // 3 = 모듈 ,4 = 모듈 작동부분 , 5 그냥 점유 부분.

        {BlockShape.One_D, new int[,]{ {1} } },

        {BlockShape.Two_HL, new int[,]{ { 1 },{1}}},
        {BlockShape.Two_VL, new int[,]{ {1,1} }},
        {BlockShape.Two_DiaR, new int[,]{ 
            {1,0},
            {0,1} }},
        {BlockShape.Two_DiaL, new int[,]{ 
            {1,0},
            {0,1} }},
        ...
        {BlockShape.Four_G, new int[,]{ 
            { 1,1,1 },
            {0,0,1 }}},
        {BlockShape.Four_AG, new int[,]{ 
            { 1,1,1 },
            {1,0,0 }}},
        ...
        {BlockShape.Two_DiaR_모듈, new int[,]{ 
            {3,5},
            {5,3} }},
